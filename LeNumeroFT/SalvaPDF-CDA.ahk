...
F3::
FileRead,lista,lista.txt
lista:= StrSplit(lista,"`n","`r`n")
loop,% lista.MaxIndex()  
{
  line:=lista[A_index]
  line:=StrSplit(line,A_Tab,A_Tab)
  ano:=line[1]
  num:=line[2]
  send,!l%ano%%A_Tab%%num%!l
  Sleep,500
  loop
    if (FindText(0,0,A_ScreenWidth,A_ScreenHeight,0,0,"|<>*120$51.z00000006A0000000lU0000006BnlswQQSzAnNgqqqS1aP1yMMnkAnMA1VaS1aPBaqqnkASD7XXXo"))
      break 
  Sleep,300
  loop
    if (doc:=FindText(0,0,A_ScreenWidth,A_ScreenHeight,0,0,"|<>*120$58.00000000T000000U0100000020040QWv7/AskEC++GWmYIVsc8d/u+F842UWYc8d4EE++OGWWYIV0b6d9m9CA7mU"))
      break 
  MouseClick,Left,doc.1.x,doc.1.y
  loop
    if (FindText(0,0,A_ScreenWidth,A_ScreenHeight,0,0,"|<>*120$69.y00000000006M0000000A00lU0000001U06ASDArwSTCSClaPBaqqPhaPSAnMAqqzNgnAlaP1aqq3BaMqMnNhqqnNgnPy3lsyqnnAnlo"))
      break 
  loop
  ...
  loop
    if (a:=FindText(0,0,A_ScreenWidth,A_ScreenHeight,0,0,ano2))
      break
  loop
    if (p:=FindText(0,0,A_ScreenWidth,A_ScreenHeight,0,0,"|<>*120$43.y000000EU000008E000004/CCCAMvt8ccdGX0YI7m4FUG+20V8k9555+IM4QQQMlo"))
      break  
  MouseClick,left,p.1.x,p.1.y
  loop
    if (FindText(0,0,A_ScreenWidth,A_ScreenHeight,0,0,"|<>*120$51.z00000006A0000000lU0000006BnlswQQSzAnNgqqqS1aP1yMMnkAnMA1VaS1aPBaqqnkASD7XXXo"))
      break  
  Sleep,300
